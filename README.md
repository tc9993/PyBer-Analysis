...
<ol>
  ...
  <li><b>Do Not Ignore Urban Cities:</b> Urban cities are PyBer's bread and butter, so to speak. Urban cities account for over 60% of all fare revenue and should not be an after thought, even if they bring in the least amount of money per ride.  The sheer volume of rides in urban cities is something to further study (i.e. how negative would the response be to a small increase in the base fare, or inversely, would more riders adopt PyBer if the base fare was slightly lower?).  Without more extensive data to analyze, it is difficult to surmise everything making the urban operation so successful besides crediting the large populations that may travel shorter distances than those members of rural and suburban communities.</li>
</ol>
